  ...
  return (
    <View style={[styles.container,{width,backgroundColor:'white'}]}>
      <StatusBar  backgroundColor={'transparent'} translucent={true}  />
        ...
        <Image source={require('../assets/images/lesson3a.png')} style={[styles.lesson_img1]}/>
        <Image source={require('../assets/images/lesson3b.png')} style={[styles.lesson_img2]}/>
      ...
      <Image source={require('../assets/images/lesson3.png')} style={[styles.lesson_img]}/>
