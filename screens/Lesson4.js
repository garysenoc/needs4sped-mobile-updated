  ...
  return (
    <View style={[styles.container,{width,backgroundColor:'white'}]}>
      <StatusBar  backgroundColor={'transparent'} translucent={true}  />
        ...
        <Image source={require('../assets/images/lesson4a.png')} style={[styles.lesson_img1]}/>
        <Image source={require('../assets/images/lesson4b.png')} style={[styles.lesson_img2]}/>
      ...
      <View style={{justifyContent:'center',alignItems:'center',marginTop:-30}}>
          ...
          <Text style={{
            ...
            textShadowRadius: 15,
            elevation: 2,
            }}>Counting Objects</Text>
        </View>
      <Image source={require('../assets/images/lesson4.png')} style={[styles.lesson_img]}/>
