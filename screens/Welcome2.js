  ...
  return (
    <View style={[styles.container,{width}]}>
        <View style={styles.imgcon}>
          <Image source={require('../assets/images/welcome_screen2.png')} style={[styles.image, { resizeMode: 'contain'}]}/>
        </View>
        <View style={styles.texts}>
          <Text style={styles.title}>Plenty of{'\n'}fun exercises</Text>
          <Text style={styles.descriptions}> The learning process is easy and{'\n'}extremely engaging.  </Text>
        </View>
        <TouchableOpacity  
          activeOpacity={.5}
          onPress={ () =>{soundClick(); navigation.navigate('Welcome3'); }}
        >
          <LinearGradient
        ...
        <View style={styles.bottom_imgcon}>
          <Image source={require('../assets/images/welcome_screen2.png')} style={[styles.bottom_image, { resizeMode: 'contain'}]}/>
        </View>
